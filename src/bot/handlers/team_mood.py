"""Аналитика настроения команды по псевдонимным (HMAC) пульс-опросам — /team_mood.
...
MOOD_RECO_PROMPT = """Ты HR-аналитик. По псевдонимным данным пульс-опросов команды дай короткие
