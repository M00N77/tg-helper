...
- «верни задачу из корзины и поставь напоминание»:
  ...
  «Пригласи команду на собрание в 10:00» / «созвони команду в 14:00» /
  «организуй онлайн-встречу и позови всех» →
  {"intent": "multi", "actions": [
    {"intent": "schedule_meeting",
     "parameters": {"title": "Онлайн-собрание", "datetime": "2026-06-14T10:00:00+03:00"}},
    {"intent": "notify_team",
     "parameters": {"message": "Приглашаем на онлайн-собрание в 10:00! Ссылка придёт следом."}}
  ]}

  ПРАВИЛО: если пользователь зовёт команду на встречу/созвон —
  ВСЕГДА создавай multi с schedule_meeting + notify_team.
  notify_team без schedule_meeting использовать только для
  общих оповещений без встречи.
