...
def upgrade() -> None:
    ...
    op.alter_column('pending_team_tasks', 'status',
               ...
               type_=sa.Enum('pending', 'processing', 'approved', 'rejected', name='taskstatus'),
               existing_nullable=False)
    op.add_column('teams', sa.Column('is_supergroup', sa.Boolean(), nullable=False))
...
def downgrade() -> None:
    ...
    op.alter_column('pending_team_tasks', 'status',
               existing_type=sa.Enum('pending', 'processing', 'approved', 'rejected', name='taskstatus'),
